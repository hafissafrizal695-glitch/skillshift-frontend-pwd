...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col app-root relative">
      ...
      {activeTab === 'home' && (
        <main className="animate-fade-in flex-1 pt-44">
      ...
      {activeTab === 'saved' && !isAdminAuth && (
        <div className="animate-fade-in p-6 md:p-10 max-w-5xl mx-auto w-full pt-44">
      ...
      {activeTab === 'admin' && isAdminAuth && (
        <div className="animate-fade-in p-6 md:p-10 max-w-6xl mx-auto w-full pt-44">
